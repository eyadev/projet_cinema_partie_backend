...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initCategories() {
		Stream.of("Histoire","Action","Darma","Fiction").forEach(cat->{
	...
	public void initFilms() {
		...
		Stream.of("Game Of Thrones","Forrest Gump","Le Parrain","Le Seigneur Des Anneaux").forEach(titreFilm->{
			Film film = new Film();
	...
	public void initProjections() {
		double[] prices = new double[] {30,50,60,90,100};
